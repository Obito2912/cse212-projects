...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue method was using 'Insert' instead of 'Add'. This caused the order of the queue to be reversed.
    ...
    // Defect(s) Found: The AddPerson method did not correctly handle adding a new person to the queue while it was being processed.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There was no handling for people with infinite turns.
    ...
    // Defect(s) Found: The GetNextPerson method did not check if the queue was empty before trying to dequeue a person.
